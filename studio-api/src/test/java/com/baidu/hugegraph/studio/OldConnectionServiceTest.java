...
public class OldConnectionServiceTest extends JerseyTest {
    private static final Logger LOG = LoggerFactory.getLogger(OldConnectionServiceTest.class);
    ...
    public OldConnectionServiceTest() {
